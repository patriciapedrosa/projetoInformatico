    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <p>
                    <b>Leitura:</b>
                    @if(is_null($sensor->leitura)) {{"N/A"}} @else {{$sensor->leitura}} @endif
                </p>
                ...
                <p>
                    ...
                    <a class="btn btn-xs btn-success" href="{{ route('pin.create', [$sensor->controlador_id, $sensor->id])}}">Adicionar Pin</a>
                </p>
